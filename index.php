            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="login.php" onclick="alert('Login Please');">Ethical Hacking</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Cyber Security</a></li>
                            <li><a href="#Programming">Programming</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Website Development</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Android & IOS Development</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Software Development</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Data Science</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Digital Marketing</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Social Media Marketing</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Novels</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                ...
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/c.png">
                            <h5><a href="login.php" onclick="alert('Login Please');">C</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/cpp.png">
                            <h5><a href="login.php" onclick="alert('Login Please');"href="login.php" onclick="alert('Login Please');">C++</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/java.png">
                            <h5><a href="login.php" onclick="alert('Login Please');">JAVA</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/matlab.png">
                            <h5><a href="login.php" onclick="alert('Login Please');"href="login.php" onclick="alert('Login Please');">MATLAB</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/r.png">
                            <h5><a href="login.php" onclick="alert('Login Please');">R</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/python.png">
                            <h5><a href="login.php" onclick="alert('Login Please');">Python</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="img/categories/ruby.jpg">
                            <h5><a href="login.php" onclick="alert('Login Please');">Ruby on Rails</a></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                    <div class="footer__widget">
                        ...
                        <ul>
                            <li><a href="login.php" onclick="alert('Login Please');">Ethical Hacking</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Cyber Security</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Programming</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Website Development</a></li>
                            <li><a href="login.php" onclick="alert('Login Please');">Android & IOS Development</a></li>
                        </ul>
                        <ul>
